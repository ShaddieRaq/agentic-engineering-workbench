...
describe("agent workbench web interface", () => {
  ...
  it("renders the foundry project index and navigates to the chain view", async () => {
    ...
    const chain = {
      ...
      latestActivityAt: "2026-08-05T10:11:00.000Z", intakeTurnCount: 6, intakeQuestions: [],
  ...
  it("records a decision from the chain view and refetches the chain", async () => {
    const chainPayload = {
      ...
      latestActivityAt: "2026-08-05T10:00:00.000Z", intakeTurnCount: 0, intakeQuestions: [],
  ...
  it("starts a stage run from the chain view and answers intake questions", async () => {
    ...
    const chainPayload = {
      ...
      latestActivityAt: "2026-08-05T10:00:00.000Z", intakeTurnCount: 2, intakeQuestions: [],
      briefVersions: [
  ...
  it("shows the intake turn panel when the latest brief version has open questions", async () => {
    const chainPayload = {
      ...
      latestActivityAt: "2026-08-05T10:00:00.000Z", intakeTurnCount: 1, intakeQuestions: [{ id: "q1", question: "Which airports matter?" }],
      briefVersions: [
