...
export function ArtifactPresentationView({
  ...
  return <>
    ...
    {presentation.improvement?.proposal?.candidatePolicyPatch && <section className="panel"><span className="eyebrow">Bounded revision surface</span><h2>Candidate policy patch</h2><pre>{JSON.stringify(presentation.improvement.proposal.candidatePolicyPatch, null, 2)}</pre></section>}
