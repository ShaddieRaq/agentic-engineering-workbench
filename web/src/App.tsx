...
function EvaluationDetailPage() {
  ...
  const [improvementOperationId, setImprovementOperationId] = useState<string | null>(null);
  const [improvementError, setImprovementError] = useState<string | null>(null);
  const [improvementGuidance, setImprovementGuidance] = useState("");
  const improvementOperation = useOperation(improvementOperationId);
