...
function EvaluationDetailPage() {
  ...
  async function analyzeFailures() {
    try {
      const started = await api<Operation>(`/api/evaluations/${encodeURIComponent(experiment.experimentId)}/improvements`, { method: "POST", body: JSON.stringify({ target: "reliability" }) });
